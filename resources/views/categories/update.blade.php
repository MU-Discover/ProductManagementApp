    ...
    <div className='m-0'>
        <form action="{{ route('update.category', $category) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div>
                    <img class="rounded mx-auto d-block flex justify-center items-center" src="{{ asset('storage/' . $category->image) }}" width="300px">
                </div>
            </div>
            ...
            <div class="mb-6">
                <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category
                    description</label>
                <textarea id="message" rows="4" name="description"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Leave a description...">{{$category->description}}</textarea>
            </div>
            <div class="mb-6">
