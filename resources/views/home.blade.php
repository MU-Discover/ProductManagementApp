    ...
    <div class="max-w-7xl mx-auto p-6 lg:p-8">
        <div class="flex justify-center">
            <h1
                ...
                List of products available in Our Shop</h1>
        </div>

        <form class="mb-6 mt-6" method="Get" action="{{ route('search') }}">
                    ...
                    <div
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                @if (session('email'))
                                    <a href="#" data-modal-target="popup-modal{{ $product->id }}"
                                    ...
                                    <div class="relative w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            <button type="button"
                                                ...
                                                data-modal-hide="popup-modal{{ $product->price }}">
